...
$reg=$groups->getByAlias($_GET['reg']); $regGet=$conn->fetchArray($reg);?>
...
<div class="content">
    ...
    <div id="bodydetail">
    	...
    	<div id="trip-box">
        	<div id="trip-box-in">
        		<? $activity=$actGet['name']; $region=$regGet['name']; ?>
				<? $tri="select * from groups where activity='$activity' and region='$region' order by weight"; $trip=mysql_query($tri);
