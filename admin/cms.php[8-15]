                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  ...
                                  <tr>
                                    <td colspan="2">
                                      ...
                                      <?php if($groupRow['linkType'] == "Contents Page" && isset($_GET['id'])){ 
																			echo "block;";
																			} else{ echo "none;"; } ?>
                                       ">
                                      <table>
                                  ...
                                  <tr>
                                    <td colspan="2">
                                      ...
                                      <?php if($groupRow['linkType'] == "Normal Group" && isset($_GET['id'])){ 
																			echo "block;";
																			} else{ echo "none;"; } ?>
                                       ">
                                      <table>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <input type="radio" value="list" name="display" class="text" style="width:15px;"<?php if($groupRow['display'] == "list") echo " checked"; ?>> List
                                            </td>
                                        </tr>
                                      </table>
                                      </div>
