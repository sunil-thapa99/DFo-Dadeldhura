...
$weight = $groups -> getLastWeight("PackageRegion", 0);
...
if($_POST['type'] == "Save")
{
	...
	if(empty($title))
		$errMsg = "Please enter Region Name";
	...
	if(empty($errMsg)){
		$groups -> saveRegion($id, $title, $urlname, $weight);
		if($id > 0)
			$msg = "Region updated successfully";
		else
			$msg = "Region saved successfully";
		header("Location: packageregion.php?msg=$msg");
		exit();
	}
}
if($_GET['type']=="del")
{
	...
	{
		$groups -> delete($id);
		header("Location: packageregion.php?msg=Region deleted successfully");
		exit();
	}
}
?>
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td bgcolor="#fff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="heading2">&nbsp;Manage Package Region
                          <div style="float: right;"> <a href="packageregion.php" class="headLink"> Add New </a> </div></td>
                      </tr>
                      <tr>
                        <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td align="right"><strong> Region Name : </strong></td>
          ...
          <td class="bgborder"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="heading2">&nbsp;Package Region List</td>
                    </tr>
                    <tr>
                      <td><table width="100%"  border="0" cellpadding="4" cellspacing="0">
                          ...
                          <tr <?php if($counter%2 != 0) echo 'bgcolor="#F7F7F7"'; else echo 'bgcolor="#FFFFFF"'; ?>>
                            ...
                            <td valign="top">
                              [<a href="packageregion.php?type=edit&id=<?= $row['id']?>">Edit</a>]
                              <? if($groups -> isDeletable($row['id'])) { ?>
                              [<a href="#" onClick="javascript: if(confirm('This will permanently remove this Region from database. Continue?')){ document.location='packageregion.php?type=del&id=<?php echo $row['id']; ?>'; }">Delete</a>]
                              <? } ?>
                            </td>
                          </tr>
                          <?
