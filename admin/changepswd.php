                          ...
                          <tr>
                            <td align="center"><form name="form1" method="post" action="">
                                <table border="0" width="100%" cellpadding="2" cellspacing="0" class="tahomabold11">
                                  ...
                                  <?php } ?>
                                  <tr>
                                    <td width="36%" align="left" valign="top"><div align="right" style="width:200px;">Enter Old Password :</div></td>
                                    <td width="64%" valign="top"><div align="left">
                                        <input name="old_psw" type="password" class="text">
                                      </div></td>
                                  </tr>
                                  <tr>
                                    <td align="left" valign="top"><div align="right" style="width:200px;">Enter New Password :</div></td>
                                    <td valign="top"><div align="left">
                                        <input name="new_psw" type="password" class="text">
                                      </div></td>
                                  </tr>
                                  <tr>
                                    <td align="left" valign="top"><div align="right" style="width:200px;">Confirm New Password :</div></td>
                                    <td valign="top"><div align="left">
